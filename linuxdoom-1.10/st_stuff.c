...
// Centered on screen (status bar patches are 320px wide from WAD)
#define ST_X				((SCREENWIDTH - 320) / 2)
#define ST_X2				((SCREENWIDTH - 320) / 2 + 104)

#define ST_FX  			((SCREENWIDTH - 320) / 2 + 143)
#define ST_FY  			(ST_Y + 37)
...
void ST_refreshBackground(void)
{
    ...
    if (st_statusbaron)
    {
	// Clear background to black before drawing centered status bar
	...
	V_CopyRect(0, 0, BG, ST_WIDTH, ST_HEIGHT, 0, ST_Y, FG);
    }
